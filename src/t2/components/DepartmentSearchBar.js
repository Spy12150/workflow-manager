...
function DepartmentSearchBar({ filters, onSearch, onReset, onViewChange, view }) {
  ...
  const handleResetClick = (e) => {
    e.preventDefault();
    const resetFilters = { department: '', projectName: '', systemName: '', person: '' };
  ...
  return (
    <form className="search-bar" onSubmit={handleSearchClick}>
      ...
      <div className="filters">
        <input type="text" name="department" placeholder="提出部门" value={localFilters.department} onChange={handleInputChange} />
